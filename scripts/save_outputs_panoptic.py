...
@click.option('--dataset_root', default="/mnt/d/Code/PaSCo-main/dataset/SemanticKITTI")
@click.option('--dataset_preprocess_root', default="/mnt/d/Code/PaSCo-main/dataset/kitti/")
@click.option('--config_path', default="/mnt/d/Code/PaSCo-main/config/semantic-kitti.yaml")
@click.option('--model_path', default="/mnt/d/Code/PaSCo-main/ckpt/pasco_single.ckpt")
